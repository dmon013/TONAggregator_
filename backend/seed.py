...
def get_test_data():
    ...
    apps = [
        {'title': 'Catizen', 'short_description': 'Увлекательная игра с котиками.', 'long_description': 'Вы можете выращивать, скрещивать и коллекционировать разнообразных котиков. Участвуйте в ивентах и получайте награды!', 'app_url': 'https://t.me/catizenbot/game', 'category_id': 'games', 'icon_url': 'https://i.ibb.co/gLQbLqFD/catizen.jpg'},
        {'title': 'MemHustle', 'short_description': 'Кликер-баттлер от ByBit.', 'long_description': 'Based game for crypto hustlers. Lead memecoins to fight market scam.', 'app_url': 'https://t.me/MemHustle_bot', 'category_id': 'games', 'icon_url': 'https://i.ibb.co/q30fvTVK/mem-Hustle.jpg'},
        {'title': 'EGGONOMIC', 'short_description': 'Официальный кошелек для TON.', 'long_description': 'Eggonomic — stake Telegram gifts, earn rewards & NFTs. ', 'app_url': 'https://t.me/eggonomicbot', 'category_id': 'tools', 'icon_url': 'https://i.ibb.co/5hFN0jXn/eggonomic.jpg'},
        {'title': 'WEB3 Portal', 'short_description': 'Точка входа в TON DNS', 'long_description': 'Вход в экосистему открыт — доступ к WEB3 App, ревардам, связи с командой, приватным каналам и чатам.', 'app_url': 'https://t.me/tondnsclub', 'category_id': 'social', 'icon_url': 'https://i.ibb.co/1YdPdfQK/web3portal.jpg'},
        {'title': 'Tonnel Relayer Bot', 'short_description': 'Gifts Market', 'long_description': '#1 Zero-Knowledge Privacy Protocol on TON💎', 'app_url': 'https://t.me/Tonnel_Network_bot', 'category_id': 'finance', 'icon_url': 'https://i.ibb.co/Fky0rnsm/tonnel.jpg'},
    ]
    news = [
